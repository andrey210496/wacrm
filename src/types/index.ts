...
export interface Contact {
  ...
  user_id: string;
  account_id: string;
  /** Owning unit — NOT NULL since migration 043. */
  unit_id: string;
  phone: string;
...
export interface Conversation {
  id: string;
  user_id: string;
  /** Owning unit — NOT NULL since migration 043. Drives per-unit send routing. */
  unit_id: string;
  contact_id: string;
...
export interface Deal {
  id: string;
  user_id: string;
  /** Owning unit — NOT NULL since migration 043. Follows the contact's unit. */
  unit_id: string;
  pipeline_id: string;
  stage_id: string;
  /**
...
export interface Broadcast {
  id: string;
  user_id: string;
  /** Owning unit — NOT NULL since migration 043. Sends go out from this unit's number. */
  unit_id: string;
  name: string;
  template_name: string;
