...
const FAIL_COPY: Record<PeekFail['reason'], { title: string; body: string }> = {
  not_found: {
    ...
    body: 'Este link não corresponde a um convite válido. Confira a URL ou peça um novo link para quem te convidou.',
  },
  used: {
    title: 'Convite já utilizado',
    body: 'Este convite já foi aceito. Se não foi você, peça ao admin da conta para enviar um novo link.',
  },
  expired: {
    title: 'Convite expirado',
    body: 'Este convite expirou. Peça ao admin da conta para enviar um novo — leva alguns segundos para gerar.',
  },
  server_error: {
        ...
        <Card className="w-full max-w-md border-border bg-card">
          ...
          <CardContent className="flex flex-col gap-3">
            ...
            <p className="text-center text-xs text-muted-foreground">
              ...
              conta pessoal vazia do cadastro será removida.
            </p>
          </CardContent>
        </Card>
