      ...
      <CardHeader>
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <CardDescription>
              Tokens gastos na sua chave de provedor por rascunhos e pelo bot
              de resposta automática. Só contagem — nenhum conteúdo de mensagem
              é armazenado aqui.
            </CardDescription>
          </div>
          <Select
      ...
      <CardContent className="space-y-5">
        {loading || !data ? (
          ...
          <div className="flex flex-col items-center justify-center gap-2 py-10 text-center text-sm text-muted-foreground">
            ...
            <p className="text-xs">
              Isto é preenchido conforme o assistente gera rascunhos e respostas automáticas.
            </p>
          </div>
        ) : (
          <>
            ...
            {data.truncated && (
              <p className="text-xs text-muted-foreground">
                Mostrando uma janela parcial — o uso é alto o bastante para que
                só os registros mais recentes sejam resumidos aqui.
              </p>
            )}
          </>
        )}
